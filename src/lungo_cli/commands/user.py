...
from ..helpers.app import gather_user_info, get_user_by_usernames, handle_common_args, print_user_info
...
def add(
    ...
    full_names: Annotated[Optional[list[str]], Option("--full-name", "-n",
                                                      help="The full name of the user to add.",
                                                      show_default=False)] = None,
    emails: Annotated[Optional[list[str]], Option("--email", "-e",
                                                  help="The email address of the user to add.",
                                                  show_default=False)] = None,
    user_roles: Annotated[Optional[list[UserRole]], Option("--user-role", "-r",
                                                           help="The role of the user to add.",
                                                           show_default=False)] = None,
